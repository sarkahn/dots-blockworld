...
public class PlaceBlockTestSystem : JobComponentSystem
{
    ...
    {
        int3 chunkIndex = GridMath.Grid3D.CellIndex(worldPos, Constants.ChunkSize);
        _chunkQuery.SetSharedComponentFilter<ChunkIndex>(chunkIndex);
        ...
        b.ResizeUninitialized(Constants.ChunkVolume);
        ...
        EntityManager.AddSharedComponentData<ChunkIndex>(blockQuery, chunkIndex);
    }
