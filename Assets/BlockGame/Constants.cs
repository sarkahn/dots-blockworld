...
public static class Constants
{
    ...
    public static readonly int2 ChunkSurfaceSize = new int2(ChunkSizeX, ChunkSizeZ);
    public static readonly int3 ChunkSize = new int3(ChunkSizeX, ChunkSizeY, ChunkSizeZ);
